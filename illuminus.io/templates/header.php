...
<link rel="apple-touch-icon" sizes="76x76" href="<?php print $control['baseurl'] ?>app/assets/img/icons/apple-icon-76x76.png">
<link rel="apple-touch-icon" sizes="114x114" href="<?php print $control['baseurl'] ?>app/assets/img/icons/apple-icon-114x114.png">
<link rel="apple-touch-icon" sizes="120x120" href="<?php print $control['baseurl'] ?>app/assets/img/icons/apple-icon-120x120.png">
<link rel="apple-touch-icon" sizes="144x144" href="<?php print $control['baseurl'] ?>app/assets/img/icons/apple-icon-144x144.png">
<link rel="apple-touch-icon" sizes="152x152" href="<?php print $control['baseurl'] ?>app/assets/img/icons/apple-icon-152x152.png">
<link rel="apple-touch-icon" sizes="180x180" href="<?php print $control['baseurl'] ?>app/assets/img/icons/apple-icon-180x180.png">
<link rel="icon" type="image/png" sizes="192x192" href="<?php print $control['baseurl'] ?>app/assets/img/icons/android-icon-192x192.png">
<link rel="icon" type="image/png" sizes="32x32" href="<?php print $control['baseurl'] ?>app/assets/img/icons/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="96x96" href="<?php print $control['baseurl'] ?>app/assets/img/icons/favicon-96x96.png">
<link rel="icon" type="image/png" sizes="16x16" href="<?php print $control['baseurl'] ?>app/assets/img/icons/favicon-16x16.png">
<link rel="manifest" href="<?php print $control['baseurl'] ?>app/assets/img/icons/manifest.json">
...
<![endif]-->
<script src="<?php print $control['baseurl'] ?>app/assets/js/jquery.min.js"></script>

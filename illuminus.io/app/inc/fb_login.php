...
// OPTION 1: Get FB data
// 1. User visits for first time
// 2. Can't or won't login || Can't get data
...
if ( isset($control['fb_login_state']) && $control['fb_login_state'] == 'no' ){
	report ('fb_login_state: ' . $control['fb_login_state']);
}

	<div class="col-sm-3 sidebar-col">
		<div class="inner">
			...
			<ul class="nav_steps">
				...
				<li><a id="step_load_data_link" href="?data_set=<?php print $control['data_set']; ?>&amp;step=load_data&amp;lang=<?php print $control['lang']; ?>"<?php if($control['step']=='load_data') print ' class="selected"'; ?>><?php print $text['meta'][$control['lang']]['nav_link_load_data'] ?></a></li>

...
$u_url = 'http://facebook.com/omundy';	
...
$fb_data = array(
	...
	'activities' 	=> array('name' => 	'activities', 
							 ...
							 'desc' => 	'The activities listed on someone\'s profile under <a href="'.$u_url.'/likes_activities">Likes > Activities</a>.',
							 'approval' => true),
  ...
  */
	...
	/* don't think this one is worth it, and it's still in development as of Jan 20, 2015						 
	'payment_transactions' => array('name' => 	'payment_transactions', 
							 'call' => 	'/me/payment_transactions',
							 'scope' => '',
							 'desc' => 	"The Facebook Payments orders this person placed with an app."),
	*/						 
